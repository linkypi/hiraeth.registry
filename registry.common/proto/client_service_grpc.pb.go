...
type ClientServiceClient interface {
	...
	SubScribe(ctx context.Context, in *SubRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	PublishServiceChanged(ctx context.Context, in *ServiceChangedRequest, opts ...grpc.CallOption) (*empty.Empty, error)
	FetchServiceInstances(ctx context.Context, in *FetchServiceRequest, opts ...grpc.CallOption) (*FetchServiceResponse, error)
	FetchMetadata(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*FetchMetadataResponse, error)
	SendHeartbeat(ctx context.Context, in *HeartbeatRequest, opts ...grpc.CallOption) (*empty.Empty, error)
}
...
func (c *clientServiceClient) SubScribe(ctx context.Context, in *SubRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *clientServiceClient) PublishServiceChanged(ctx context.Context, in *ServiceChangedRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
func (c *clientServiceClient) FetchMetadata(ctx context.Context, in *empty.Empty, opts ...grpc.CallOption) (*FetchMetadataResponse, error) {
...
func (c *clientServiceClient) SendHeartbeat(ctx context.Context, in *HeartbeatRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
...
type ClientServiceServer interface {
	...
	SubScribe(context.Context, *SubRequest) (*empty.Empty, error)
	PublishServiceChanged(context.Context, *ServiceChangedRequest) (*empty.Empty, error)
	FetchServiceInstances(context.Context, *FetchServiceRequest) (*FetchServiceResponse, error)
	FetchMetadata(context.Context, *empty.Empty) (*FetchMetadataResponse, error)
	SendHeartbeat(context.Context, *HeartbeatRequest) (*empty.Empty, error)
}
...
func (UnimplementedClientServiceServer) SubScribe(context.Context, *SubRequest) (*empty.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method SubScribe not implemented")
}
func (UnimplementedClientServiceServer) PublishServiceChanged(context.Context, *ServiceChangedRequest) (*empty.Empty, error) {
...
func (UnimplementedClientServiceServer) FetchMetadata(context.Context, *empty.Empty) (*FetchMetadataResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method FetchMetadata not implemented")
}
func (UnimplementedClientServiceServer) SendHeartbeat(context.Context, *HeartbeatRequest) (*empty.Empty, error) {
...
func _ClientService_FetchMetadata_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ClientServiceServer).FetchMetadata(ctx, req.(*empty.Empty))
	}
	return interceptor(ctx, in, info, handler)
}
