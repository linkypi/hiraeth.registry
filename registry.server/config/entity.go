...
func (n NodeInfo) GetExternalHttpAddr() string {
	return n.Ip + ":" + strconv.Itoa(n.ExternalHttpPort)
}

func (n NodeInfo) GetExternalTcpAddr() string {
	return n.Ip + ":" + strconv.Itoa(n.ExternalTcpPort)
}
...
func (n NodeInfo) MarshalJSON() ([]byte, error) {
	return json.Marshal(map[string]interface{}{
		...
		"addr":                  n.Addr,
		"externalHttpPort":      n.ExternalHttpPort,
		"externalTcpPort":       n.ExternalTcpPort,
		"IsCandidate":           n.IsCandidate,
		"AutoJoinClusterEnable": n.AutoJoinClusterEnable,
	})
}
...
const (
	...
	// ServiceInstanceUnhealthyTimeoutSec If one service instance not updated for more than 15 seconds
	// it is marked as unhealthy, default value is 15s
	ServiceInstanceUnhealthyTimeoutSec = "service.instance.unhealthy.timeout.sec"
	// ServiceInstanceRemoveTimeoutSec if one service instance not updated for more than 30 seconds
	// the service instance is removed, default value is 30s
	ServiceInstanceRemoveTimeoutSec = "service.instance.remove.timeout.sec"
)
...
type ClusterConfig struct {
	...
	ServiceInstanceUnhealthyTimeoutSec int
	ServiceInstanceRemoveTimeoutSec    int
...
var ServiceInstanceUnhealthyTimeoutSecProp = property{
	dataType:     "int",
	propName:     "ServiceInstanceUnhealthyTimeoutSec",
	key:          ServiceInstanceUnhealthyTimeoutSec,
	require:      false,
	defaultVal:   15,
	parseHandler: validateNumber,
}
var ServiceInstanceRemoveTimeoutSecProp = property{
	dataType:     "int",
	propName:     "ServiceInstanceRemoveTimeoutSec",
	key:          ServiceInstanceRemoveTimeoutSec,
	require:      false,
	defaultVal:   30,
	parseHandler: validateNumber,
}
...
func init() {
	properties = append(properties, ServiceInstanceUnhealthyTimeoutSecProp)
	properties = append(properties, ServiceInstanceRemoveTimeoutSecProp)
